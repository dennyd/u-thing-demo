...
public class CameraController : MonoBehaviour {
	...
	public const float DragSpeed = 20f;

	public const float ScrollArea = 25;
	public const float ScrollSpeed = 10f;

	public const float LevelArea = 100;
	public const float ZoomMin = 2;
	public const float ZoomMax = 15;
